...
Rook es un proyecto de código abierto que actúa como un orquestador y gestor de almacenamiento para Kubernetes. Convierte los sistemas de almacenamiento complejos en servicios autónomos y fáciles de gestionar dentro de tu clúster.

## ¿Qué hace exactamente?

- **Automatización**: Utiliza un operador de Ceph para automatizar el despliegue, la configuración, el aprovisionamiento y el mantenimiento del almacenamiento.

- **Tipos de almacenamiento:** Entrega almacenamiento persistente en bloque, de archivos y de objetos directamente para tus aplicaciones. 

- **Persistencia:** Permite que las bases de datos y aplicaciones guarden su información de manera segura y escalable

# MinIO 

MinIO es un sistema de almacenamiento de objetos de alto rendimiento, distribuido y totalmente compatible con la API de Amazon S3. En el ecosistema de la CNCF (Cloud Native Computing Foundation), se utiliza como el estándar de la industria para gestionar, almacenar y procesar nubes de datos no estructurados, cargas de trabajo de IA/ML y Data Lakes de forma nativa en Kubernetes.

## ¿Qué es MinIO?
En pocas palabras, MinIO es como tener tu propio Amazon S3 en local, pero sin tener que pagar por ello ni depender de Internet. Es una plataforma open-source que replica el almacenamiento de objetos de S3, lo que significa que cualquier herramienta que funcione con S3 también va a funcionar con MinIO.
