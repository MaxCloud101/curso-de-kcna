...
**¿Qué es MinIO?** En pocas palabras, MinIO es como tener tu propio Amazon S3 en local, pero sin tener que pagar por ello ni depender de Internet. Es una plataforma open-source que replica el almacenamiento de objetos de S3, lo que significa que cualquier herramienta que funcione con S3 también va a funcionar con MinIO.
